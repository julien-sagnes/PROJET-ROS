...
class LineFollowingNode(Node):
    def __init__(self):
        super().__init__('line_obstacles_node') # initialisation du noeud avec le nom "line_obstacles_node"
        ...
        self.get_logger().info('Line_obstacles node started !')
    ...
    def image_callback(self, img_msg):
        if not self.stop_running.data:
            ...
            if contours_red and contours_green:
                ...
                twist = Twist()
                twist.linear.x = 0.0
                twist.angular.z = 0.5  # tourne sur place
                self.cmd_vel_publisher.publish(twist)
