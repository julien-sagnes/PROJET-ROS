...
def generate_launch_description():
    ...
    x_pose = DeclareLaunchArgument('x_pose', default_value='-0.09', description='x coordinate of robot')
    y_pose = DeclareLaunchArgument('y_pose', default_value='-0.22', description='y coordinate of robot')
    yaw_angle = DeclareLaunchArgument('yaw_angle', default_value='0.0', description='yaw angle of robot')
