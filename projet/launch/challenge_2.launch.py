...
def generate_launch_description():
    ...
    x_pose = DeclareLaunchArgument('x_pose', default_value='-0.78', description='x coordinate of robot')
    y_pose = DeclareLaunchArgument('y_pose', default_value='0.70', description='y coordinate of robot')
